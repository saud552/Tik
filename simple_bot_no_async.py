...
"""
بوت بلاغات TikTok - النسخة البسيطة بدون async
"""
...
class SimpleBotNoAsync:
    ...
    def start_command(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        if update.effective_user.id != ADMIN_USER_ID:
            update.message.reply_text("❌ عذراً، هذا البوت متاح للمدير فقط.")
            return
    ...
    def start_add_account(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        """بدء إضافة حساب"""
    ...
    def handle_username(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        """معالجة اسم المستخدم"""
    ...
    def handle_password(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        """معالجة كلمة المرور"""
    ...
    def main_menu_callback(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    def cancel_command(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        """أمر الإلغاء"""
        update.message.reply_text(
            "❌ تم إلغاء العملية.",
            reply_markup=self.get_main_menu()
...
if __name__ == "__main__":
    ...
    print("=" * 50)
    print("🎯 بوت بلاغات TikTok - النسخة البسيطة بدون async")
    print("=" * 50)
